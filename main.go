...
func flagUsage() {
	usageText := `Apolune generates off-chain data for Prodefi contracts

	Usage:
	apolune command [arguments]
	The commands are:
	...
	Use "apolune [command] --help" for more information about a command.`
